  ...
  "zh-CN": {
    translation: {
      ...
      qualityGuard: {
        ...
        sources: { active: "主动探针", passive: "请求审计" }, quarantined: "已隔离", suspect: "可疑", healthy: "正常", pending: "待观测", probeFailed: "检测失败",
        ...
        unavailable: "质量守护尚未连接", unavailableHelp: "为主服务挂载 guard 状态卷，并设置 QUALITY_GUARD_STATE_FILE 后，这里会显示实时状态。", testing: "正在检测节点质量", testComplete: "检测完成：{{speed}}", testFailed: "质量检测暂不可用，请稍后重试",
