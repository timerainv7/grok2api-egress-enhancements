  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        bfsPresent: "bfs=1",
        bfsAbsent: "无 bfs=1",
        bfsTooltip: "Build Access Token 的 JWT 声明包含 bfs=1",
